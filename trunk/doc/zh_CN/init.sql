...
insert into cs_resource (id, resource_type, application, value, position) values(2, 'url', 'csadmin', '/admin', 2.0);
insert into cs_resource (id, resource_type, application, value, position) values(3, 'url', 'csadmin', '/admin?method=browse*', 2.0);
insert into cs_resource (id, resource_type, application, value, position) values(4, 'url', 'csadmin', '/admin?method=create*', 2.1);
insert into cs_resource (id, resource_type, application, value, position) values(5, 'url', 'csadmin', '/admin?method=update*', 2.2);
insert into cs_resource (id, resource_type, application, value, position) values(6, 'url', 'csadmin', '/admin?method=delete*', 2.3);

insert into cs_resource (id, resource_type, application, value, position) values(7, 'url', 'csadmin', '/role', 3.0);
insert into cs_resource (id, resource_type, application, value, position) values(8, 'url', 'csadmin', '/role?method=browse*', 3.0);
insert into cs_resource (id, resource_type, application, value, position) values(9, 'url', 'csadmin', '/role?method=create*', 3.1);
insert into cs_resource (id, resource_type, application, value, position) values(10, 'url', 'csadmin', '/role?method=update*', 2.2);
insert into cs_resource (id, resource_type, application, value, position) values(11, 'url', 'csadmin', '/role?method=delete*', 3.3);
...
insert into cs_resource_x_authority values(3, 2);
...
insert into cs_resource_x_authority values(9, 7);
insert into cs_resource_x_authority values(10, 8);
insert into cs_resource_x_authority values(11, 9);