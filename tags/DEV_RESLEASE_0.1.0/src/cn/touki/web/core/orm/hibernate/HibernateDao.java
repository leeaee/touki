...
import cn.touki.web.core.orm.PropertyFilter.MatchType;
...
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
	...
	public Page<T> findPage(final Page<T> page, final String hql, final Object... values) {
		...
		if (page.isAutoCount()) {
			long entryCount = countHqlResult(hql, values);
			page.setEntryCount(entryCount);
		}
	...
	public Page<T> findPage(final Page<T> page, final Criterion... criterions) {
		...
		if (page.isAutoCount()) {
			int entryCount = countCriteriaResult(c);
			page.setEntryCount(entryCount);
		}
	...
	protected Query setPageParameter(final Query q, final Page<T> page) {
		...
		q.setFirstResult(page.getEntryStart() - 1);
	...
	protected Criteria setPageParameter(final Criteria c, final Page<T> page) {
		//hibernate的firstResult的序号从0开始
		c.setFirstResult(page.getEntryStart() - 1);
